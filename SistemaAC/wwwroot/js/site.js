...
var getEstudiante = () => {
    ...
    if (1 < count) {
        document.getElementById("mensajeEstudiante").innerHTML = "Sleccione un estudiante";
    } else {
...
var getCurso = () => {
    ...
    if (1 < count) {
        document.getElementById("mensajeCurso").innerHTML = "Slecccione un curso";
    } else {
...
var getMisCurso = (curso, id, asignacion) => {
    misCursos.getMisCurso(curso, id, asignacion);
}
$('#Curso').typeahead({
    source:(query, result)=> {
